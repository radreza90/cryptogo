...
const navigation = [
  ...
  { name: "Signal", href: "/panel/signal", icon: Bars4Icon, current: false },
  { name: "event", href: "/panel/event", icon: ClockIcon, current: false },
];
const teams = [
...
const PanelSideBar = ({ sidebarOpen, setSidebarOpen }) => {
  return (
    <>
